    ...
    <div style={{ display: "flex", flexDirection: "column", gap: 24 }}>
      ...
      >
        <div>
          ...
          <p style={{ fontSize: 13, color: "var(--text-muted)" }}>
            Business intelligence, booking trends and growth metrics
          </p>
        </div>
      ...
      <div className="card">
        <div className="card-header">
          <div>
            ...
            >
              Monthly breakdown: Flights · Hotels · Cabs · Packages
            </div>
          </div>
        ...
        <div className="card">
          <div className="card-header">
            <div>
              ...
              >
                Daily searches vs confirmed bookings this week
              </div>
            </div>
                ...
                >
                  {monthlyData.map((_, i) => (
                    <Cell
                      key={i}
                      fill={
                        i === monthlyData.length - 1 ? "#6366f1" : "#8b5cf640"
                      }
                    />
                  ))}
                </Bar>
      ...
      >
        {[
          {
            icon: Plane,
            label: "Flight Revenue Share",
            val: "40.1%",
            color: "#3b82f6",
            note: "Highest contributor",
            path: "/flights",
          },
          {
            icon: Hotel,
            label: "Hotel Fill Rate",
            val: "74%",
            color: "#8b5cf6",
            note: "Room occupancy",
            path: "/hotels",
          ...
          {
            icon: Car,
            label: "Cab Completion Rate",
            val: "96.2%",
            color: "#22c55e",
            note: "Rides fulfilled",
            path: "/cabs",
          },
          {
            icon: Package,
