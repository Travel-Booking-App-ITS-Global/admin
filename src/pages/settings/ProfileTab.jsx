...
export default function ProfileTab() {
  ...
  const handleFileUpload = (e) => {
    ...
    addToast(`${file.name} securely added to Vault.`, "success");
  };
      ...
      <div className="card">
        <div
          style={{
            ...
            background: "linear-gradient(to right, rgba(var(--brand-500-rgb, 59, 130, 246), 0.05), transparent)",
          }}
        >
          <div
            style={{
          ...
          <form onSubmit={handleSaveProfile} style={{ display: "flex", flexDirection: "column", gap: 20 }}>
            ...
            >
              <div style={{ position: "relative" }}>
                {profileAvatar ? (
                  ...
                  >
                    {profileName ? profileName.split(" ").map((x) => x[0]).slice(0, 2).join("").toUpperCase() : "SA"}
                  </div>
                )}
                <label
                  style={{
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16 }}>
              ...
              <div className="form-group">
                ...
                <div style={{ position: "relative" }}>
                  ...
                  <input type="text" className="form-input" style={{ paddingLeft: 38 }} value={profileName} onChange={(e) => setProfileName(e.target.value)} required />
                </div>
              </div>
              {/* Role */}
              <div className="form-group">
                ...
                <div style={{ position: "relative" }}>
                  ...
                  <input type="text" className="form-input" style={{ paddingLeft: 38 }} value={profileRole} onChange={(e) => setProfileRole(e.target.value)} />
                </div>
              </div>
            </div>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16 }}>
              ...
              <div className="form-group">
                ...
                <div style={{ position: "relative" }}>
                  ...
                  <input type="email" className="form-input" style={{ paddingLeft: 38 }} value={profileEmail} onChange={(e) => setProfileEmail(e.target.value)} required />
                </div>
              </div>
              {/* Phone */}
              <div className="form-group">
                ...
                <div style={{ position: "relative" }}>
                  ...
                  <input type="text" className="form-input" style={{ paddingLeft: 38 }} value={profilePhone} onChange={(e) => setProfilePhone(e.target.value)} />
                </div>
              </div>
            </div>
            ...
            <div className="form-group">
              ...
              <div style={{ position: "relative" }}>
                ...
                <input type="text" className="form-input" style={{ paddingLeft: 38 }} value={profileLocation} onChange={(e) => setProfileLocation(e.target.value)} />
              </div>
            </div>
            ...
            <div className="form-group">
              ...
              <div style={{ position: "relative" }}>
                ...
                <textarea
                  ...
                  style={{ paddingLeft: 38, minHeight: 80, paddingTop: 10, resize: "vertical" }}
                  value={profileBio}
      ...
      <div className="card" style={{ border: "1px solid var(--border-default)" }}>
        <div
          style={{
            padding: "20px 24px",
            borderBottom: "1px solid var(--border-default)",
            background: "linear-gradient(to right, rgba(16, 185, 129, 0.05), transparent)", // Greenish gradient
          }}
        >
          <div
            style={{
        ...
        <div style={{ padding: "24px" }}>
          ...
          >
            <UploadCloud size={32} color="var(--brand-500)" style={{ margin: "0 auto 12px" }} />
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
            <div style={{ fontSize: 13, fontWeight: 700, color: "var(--text-primary)", marginBottom: 4 }}>
              Stored Documents ({vaultDocs.length})
            </div>
                  ...
                  <div style={{ display: "flex", alignItems: "center", gap: 12, overflow: "hidden" }}>
                    <div
                      style={{
                        ...
                        height: 36,
                        borderRadius: "8px",
                        background: "rgba(var(--brand-500-rgb, 59, 130, 246), 0.1)",
                        color: "var(--brand-600)",
                        display: "flex",
                        alignItems: "center",
                        justifyContent: "center",
